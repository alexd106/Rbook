...
What we see above is the underlying code for this particular function. As we did in [Chapter 4](#graphics_r), we could copy and paste this into our own script and make any changes we deemed necessary. This approach isn't limited to `ggplot2` functions and can be used for other functions as well, although tread carefully and test the changes you've made.
