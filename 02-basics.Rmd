...
Admittedly the help files can seem anything but helpful when you first start using R. This is probably because they're written in a very concise manner and the language used is often quite technical and full of jargon. Having said that, you do get used to this and will over time even come to appreciate a certain beauty in their brevity (honest!). One big advantage of the R help file is that the structure is consistent no matter what function you are looking for help with. Each help file will contain a number of sections described below.   
