...
It is also often useful to be able to extract values from a vector using a logical condition. For example, to extract all elements with a value greater than 4 in the vector `my_vec`
