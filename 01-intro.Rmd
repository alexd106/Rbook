...
In addition to using RStudio Projects, it's also really good practice to structure your directory in a consistent and logical way to help both you and your collaborators. We frequently use the following directory structure in our R based projects
...
In our working directory we have the following directories: 
  ...
  - **R** - This is an optional directory where we save all of our custom R functions we have written for the current analysis. These can then be sourced into R using the `source()` function.  
