...
As you guess, changing text colour in R Markdown is possible. There are many codes to do it.
<li>If your output is an HTML file, you can wrap your text in the <span> tag and set colour with CSS. For example: `<span style="color: red;">The quick brown fox jumps over the lazy dog</span>`.</li>
