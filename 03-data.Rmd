...
```{r data_struc, echo=FALSE, out.width="70%", fig.align="center"}
...
```{r data_struc2, echo=FALSE, out.width="70%", fig.align="center"}
...
It's often useful to define row and column names 
...
R has numerous built in functions to perform matrix operations. Below are some of the most useful
...
```{r, echo=TRUE, eval=TRUE, collapse=TRUE}
mat.1 <- matrix(c(2, 0, 1, 1), nrow = 2)	# notice that the matrix has been filled column-wise
mat.1
