...
As many of the base R plotting functions don't have a `data =`\index{with()} argument to specify the data frame name directly we can use the `with()\index{with()}` function in combination with `plot()` as a shortcut.
