...
We decided to write this book as a freely available open source book for a number of reasons. Firstly, we hope this book will be a living document that evolves over time. If you find any errors in the book or want to make a suggestion for how to improve it, please open an issue on the [Github site][github-issue]  This book is meant to be a living document, which is why its source is available online at https://github.com/poldrack/psych10-book. If you find any errors in the book or want to make a suggestion for how to improve it, please open an issue on the Github site. Even better, submit a pull request with your suggested change.

release of bookdown - easy to write
open science
...
This book is written in [RMarkdown][rmarkdown] and published with [bookdown][bookdown].
