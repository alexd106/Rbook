...
We decided to write this book as a freely available open source document for a number of reasons. Firstly,  with the we hope this book will be a living document that naturally evolves over time. If you find any errors in the book or want to make a suggestion to improve it, please open an issue on the [Github site][github-issue]. If you want to take a peek at all the code behind the book visit the book [Github repo][github-repo]. Secondly, the release of the [bookdown][bookdown] package by Yihui Xie has made it incredibly easy to write, update and maintain a book using [RMarkdown][rmarkdown] and [RStudio][rstudio].   
...
- If you find yourself staring at code for hours trying to find out why it's not working then walk away for a few minutes. I have lost count of the number of times I was able to spot my mistake almost immediately after returning from a short caffeine break.
