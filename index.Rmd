...
<div style= "float:left;position: relative; top: 5px;">
```{r, out.width = "200px", out.extra='style="padding:30px;"', echo = FALSE}
knitr::include_graphics("images/francesca.png")
```
</div>

\  

**Francesca Mancini** *TODO**
...
**David Lusseau** is a Professor of Marine Sustainability at teh Danish Technical University. He has been using R for 15 years and teaching it for 12 years.

- Web: https://www.abdn.ac.uk/sbs/people/profiles/d.lusseau
