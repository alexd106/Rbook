...
We want you to be able to enjoy this book completely free of charge, so we've licensed it under the Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0) License (https://creativecommons.org/licenses/by-sa/4.0/).

If you teach R, feel free to use some or all of the content in this book to help support your own students. The only things we ask are that you acknowledge the original source and authors, and that any adapted versions you create are shared under the same or a compatible licence. If you find this book useful or have any comments or suggestions, we would love to hear from you (you'll find us lurking on [GitHub](#whoarewe)).
...
**ShareAlike** — If you remix, transform, or build upon the material, you must distribute your contributions under the same license as the original (or a compatible license).
