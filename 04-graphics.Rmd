...
(Think I want the following removed. Debatable if reader would care about this / want to have screen space taken up)
...
```{r qplot scatterplot starting-figure, echo=TRUE, out.width="75%", fig.align="center"}
qplot(x = mtcars$mpg, y = mtcars$hp)
```

## Altering an axis label
...
### Axis label - In ggplot2

(Content to follow)

```{r qplot labels, echo=TRUE, out.width="75%", fig.align="center"}
qplot(x = mtcars$mpg, y = mtcars$hp,
		 xlab = "Horsepower",
		 ylab = "Miles per Gallon")
```
