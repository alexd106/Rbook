...
When using spatial data, heatmaps can be a great tool to visual spatial patterns. `ggplot2` can easily handle such data using `geom_bin2d()`.
...
Similar to a heatmap we can make a contour map using `geom_density_2d()`.
